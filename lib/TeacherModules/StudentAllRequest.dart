...
class StudentAllRequest extends StatelessWidget {
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: Container(
                                            height: 45,
                                            decoration: BoxDecoration(color: data['classTeacherApproval']=="Pending"? Color(0xff1DB954)
                                                :data['classTeacherApproval']=="Approved"? Color(0xff1DB954).withOpacity(0.5)
                                            ...
                                            child: TextButton(
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  SizedBox(width: 5,),
                                                  Container(
                                                      child: data['classTeacherApproval']=="Pending"? Text("Approve",style: TextStyle(color: Colors.white,fontSize: 17,fontWeight: FontWeight.w500))
                                                          :data['classTeacherApproval']=="Approved"? Text("Approved",style: TextStyle(color: Colors.white,fontSize: 17,fontWeight: FontWeight.w500))
                                        ...
                                        Expanded(
                                          child: Container(
                                            height: 45,
                                            decoration: BoxDecoration(color: data['classTeacherApproval']=="Pending"? Color(0xffDC3545)
                                                :data['classTeacherApproval']=="Rejected"? Color(0xffDC3545).withOpacity(0.5)
                                            ...
                                            child: TextButton(
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  SizedBox(width: 5,),
                                                  Container(
                                                      child: data['classTeacherApproval']=="Pending"? Text("Reject",style: TextStyle(color: Colors.white,fontSize: 17,fontWeight: FontWeight.w500),)
                                                          :data['classTeacherApproval']=="Rejected"? Text("Rejected",style: TextStyle(color: Colors.white,fontSize: 17,fontWeight: FontWeight.w500),)
