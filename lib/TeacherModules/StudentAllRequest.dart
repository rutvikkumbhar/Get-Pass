                                        ...
                                        Expanded(
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(color: data['classTeacherApproval']=="Pending"? const Color(0xff1DB954)
                                                :data['classTeacherApproval']=="Approved"? const Color(0xff1DB954).withValues(alpha: 0.5)
                                        ...
                                        Expanded(
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(color: data['classTeacherApproval']=="Pending"? const Color(0xffDC3545)
                                                :data['classTeacherApproval']=="Rejected"? const Color(0xffDC3545).withValues(alpha: 0.5)
