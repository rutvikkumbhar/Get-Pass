                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ListTile(
                              title: Text("Class",style: TextStyle(color: Colors.black.withValues(alpha: 0.6),fontSize: 15),),
                              subtitle: Text("${data['class']}",style:  const TextStyle(color: Colors.black,fontSize: 17),),
                            ...
                            const SizedBox(height: 10,),
                            ListTile(
                              title: Text("Total Leaves",style: TextStyle(color: Colors.black.withValues(alpha: 0.6),fontSize: 15),),
                              subtitle: Text("${data['totalLeave']}/5",style:  const TextStyle(color: Colors.black,fontSize: 17),),
                              leading:  const Icon(Icons.school_rounded,color: Color(0xff3F72AF),),
                            ),
                            Padding(
                              padding:  const EdgeInsets.only(left: 10,right: 10),
