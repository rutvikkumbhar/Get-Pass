...
class TeaApprovedLeaves extends StatefulWidget {
  const TeaApprovedLeaves({super.key});
  @override
  State<TeaApprovedLeaves> createState() => _TeaApprovedLeavesState();
}

class _TeaApprovedLeavesState extends State<TeaApprovedLeaves> {
                    ...
                    return ListView.builder(
                        ...
                        itemBuilder: (itemBuilder, index){
                          DocumentSnapshot data=streamSnapshot.data!.docs[index];
                            return data['classTeacherApproval']=="Approved"? Padding(
