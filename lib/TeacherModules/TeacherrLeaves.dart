              ...
              return ListView.builder(
                ...
                itemBuilder: (itemBuilder, index){
                  ...
                  return Padding(
                    ...
                    child: Container(
                      decoration: BoxDecoration(color: Colors.grey.withValues(alpha: 0.1),borderRadius: BorderRadius.circular(15)),
                      child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Container(
                                        child: data['prinApproval']=="Approved"? const Icon(Icons.check_circle_rounded,color: Color(0xff16C47F),size: 20,)
                                            :data['prinApproval']=="Rejected"? const Icon(Icons.cancel_rounded,color: Color(0xffD91656),size: 20,)
                                            : const Icon(Icons.access_time_filled_rounded,color: Color(0xffF39E60),size: 20,),
                                      ),
                                       const SizedBox(width: 5,),
                                      Container(
                                        child: data['prinApproval']=="Approved"? const Text("Approved",style: TextStyle(color: Color(0xff16C47F),fontSize: 17,fontWeight: FontWeight.w500),)
                                            :data['prinApproval']=="Rejected"? const Text("Rejected",style: TextStyle(color: Color(0xffD91656),fontSize: 17,fontWeight: FontWeight.w500),)
