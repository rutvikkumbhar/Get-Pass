        ...
        child: ListView(
          children: [
            ...
            Text("The Get Pass App is an open-source project designed to simplify and enhance the leave management process for students, teachers, and HODs at V.V.P Polytechnic, Soregaon. This app serves as a comprehensive platform to manage leave requests, provide feedback, and streamline communication within the college.",
              style: TextStyle(color: Colors.black.withValues(alpha: 0.6),fontSize: 15),textAlign: TextAlign.justify,),
            ...
            Text("This app was developed as an open-source project exclusively for V.V.P Polytechnic. It was designed and developed by a student from the Computer Engineering Department, showcasing the talent and dedication of our college's budding engineers.",
              style: TextStyle(color: Colors.black.withValues(alpha: 0.6),fontSize: 15),textAlign: TextAlign.justify,),
             const SizedBox(height: 25,),
            Container(
              height: 1,width: MediaQuery.of(context).size.width,
            ...
            //   style: TextStyle(color: Colors.black.withValues(0.6),fontSize: 15),textAlign: TextAlign.justify,),
            // GestureDetector(
            //   child: Text("$uri",style:  TextStyle(color: Color(0xff769FCD),fontSize: 15,fontWeight: FontWeight.w500),),
            //   onTap: () async {
            ...
            Text("\"Creating this app was a journey of learning and innovation. My goal was to contribute something meaningful to my college community while honing my technical skills. I hope this app brings value to its users and inspires others to embark on similar projects.\"",
              style: TextStyle(color: Colors.black.withValues(alpha: 0.6),fontSize: 15,fontStyle: FontStyle.italic),textAlign: TextAlign.justify,),
             // SizedBox(height: 25,),
            //  Column(
            //   mainAxisAlignment: MainAxisAlignment.start,
            //   crossAxisAlignment: CrossAxisAlignment.center,
            //   children: [
            //     Text("Version: (Beta) | Open Source"),
