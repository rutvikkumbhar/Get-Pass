  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: StreamBuilder(
          stream: ref1.orderBy('appliedAt', descending: true).where('hodID', isEqualTo: auth.currentUser!.uid).snapshots(),
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(color: data['hodApproval']=="Pending"? const Color(0xff1DB954)
                                        :data['hodApproval']=="Approved"? const Color(0xff1DB954).withValues(alpha: 0.5)
                                    ...
                                    child: TextButton(
                                      ...
                                      onPressed: () async {
                                        ...
                                        await ref.doc(data.id).update({
                                          ...
                                          String? studToken = (await FirebaseFirestore.instance.collection('Teachers').doc(data['userID']).get()).data()?['fcmToken'];
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(color: data['hodApproval']=="Pending"? const Color(0xffDC3545)
                                        :data['hodApproval']=="Rejected"? const Color(0xffDC3545).withValues(alpha: 0.5)
