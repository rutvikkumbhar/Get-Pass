                           ...
                           decoration: BoxDecoration(color:  const Color(0xffDDE6ED),borderRadius: BorderRadius.circular(5)),
                             child: Padding(
                               ...
                               child: Column(
                                 ...
                                 children: [
                                   Text("${data['title']}",style: TextStyle(color: Colors.black.withValues(alpha: 0.7),fontSize: 17,fontWeight: FontWeight.w500),),
                                   ...
                                   Text(":- ${data['description']}",
                                     style: TextStyle(color: Colors.black87.withValues(alpha: 0.6),fontSize: 16,fontWeight: FontWeight.w400),),
                                    const SizedBox(height: 10,),
                                   Row(
                                     mainAxisAlignment: MainAxisAlignment.end ,
                                     children: [
                                       Text("${data['appliedAt']}",style: TextStyle(color: Colors.black.withValues(alpha: 0.6),fontSize: 15,fontWeight: FontWeight.w500),),
                                     ],
                                   ),
                                 ],
                               ),
