...
class TeacherInformation extends StatefulWidget {
  ...
  String? document;
  TeacherInformation({required this.document});
}
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ListTile(
                        title: Text("Class",style: TextStyle(color: Colors.black.withOpacity(0.6),fontSize: 15),),
                        subtitle: Text("${data['class']}",style:  TextStyle(color: Colors.black,fontSize: 17),),
