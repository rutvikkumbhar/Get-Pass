                      ...
                      children: [
                          ...
                          child: Column(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text("${data['name']}",style:  const TextStyle(color: Colors.black,fontSize: 18,fontWeight: FontWeight.w500),),
                              ),
                              const SizedBox(height: 30,),
                            ],
                          ),
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ListTile(
                                title: Text("Principle",style: TextStyle(color: Colors.black.withValues(alpha: 0.6),fontSize: 15),),
                                subtitle: Text("${data['college']}",style:  const TextStyle(color: Colors.black,fontSize: 17),),
                              ...
                              const SizedBox(height: 10,),
                              ListTile(
                                title: Text("ID",style: TextStyle(color: Colors.black.withValues(alpha: 0.6),fontSize: 15),),
                                subtitle: Text("${data['userID']}",style:  const TextStyle(color: Colors.black,fontSize: 17),),
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: ListTile(
                        ...
                        leading:  const Icon(Icons.logout_outlined,color: Color(0xff3F72AF),),
                        trailing:  const Icon(Icons.keyboard_arrow_right_rounded,size: 28,),
                        onTap: (){
                          showDialog(
                            context: context,
                              ...
                              return  AlertDialog(
                                ...
                                actions: [
                                  ...
                                  TextButton(
                                    ...
                                    onPressed: (){
                                      _auth.signOut();
                                      Navigator.of(context).pushAndRemoveUntil( MaterialPageRoute(builder: (context) => const LoginOption()),
