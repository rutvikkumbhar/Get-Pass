...
class PrinHODRejectedLeaves extends StatelessWidget {
  CollectionReference ref1=FirebaseFirestore.instance.collection('HOD Leaves');
  PrinHODRejectedLeaves({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("HOD Rejected Leaves"),
      ),
      body: Padding(
            ...
            if(streamSnapshot.connectionState == ConnectionState.waiting){
              ...
              return ListView.builder(
                ...
                itemBuilder: (itemBuilder, index){
                  ...
                  return data['principleApproval']=="Rejected"?Padding(
